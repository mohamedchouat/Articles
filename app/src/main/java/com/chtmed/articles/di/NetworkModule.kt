...
object NetworkModule {
    ...
    fun provideLoggingInterceptor(): HttpLoggingInterceptor =
        HttpLoggingInterceptor().apply {
            // BODY logging is convenient in debug builds; consider gating this
            // behind BuildConfig.DEBUG for a real production app.
    ...
    @Provides
    @Singleton
    fun provideDevToApiService(retrofit: Retrofit): DevToApiService =
        retrofit.create(DevToApiService::class.java)
}
